...
def test_input_rule(test_file):
    ...
    if rule.is_validated is False:
        ...
        app_logger.details(f"PASSED: test input rule  {rule.sources}")
    app_logger.details(f"test PASSED")
...
def test_output_rule(test_file):
    ...
    if rule.is_structure_valid is False:
        ...
        app_logger.details(f"PASSED: test Rule {rule.nomenclature}")
        app_logger.details(f"Supported LMSD classes: {rule.supported_lmsd_classes}")
    app_logger.details(f"test PASSED")
